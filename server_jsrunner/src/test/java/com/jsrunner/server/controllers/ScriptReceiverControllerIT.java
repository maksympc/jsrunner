...
public class ScriptReceiverControllerIT {
...
//        //prepare
//        String expected = "To add JavaScript sourceCode you should pass it in the body of request with next configuration<br>" +
